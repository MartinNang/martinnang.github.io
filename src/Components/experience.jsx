      ...
      <div class="content-wrapper">
        <article class="ac-container">
          ...
          <div>
            ...
            />
            <label for="ac-work-1">
              Developer · <i>Infinica a Doxee Company, Vienna, Austria</i> ·{" "}
          ...
          <div>
            ...
            <label for="ac-work-2">
              Quality Management Intern · <i>BAWAG P.S.K., Vienna, Austria</i> ·{" "}
          ...
          <div>
            ...
            <label for="ac-work-3">
              Digital Banking Intern · <i>BAWAG P.S.K., Vienna, Austria</i> ·{" "}
              <span>July 2018 - August 2018</span>
            </label>
            <div class="">
              <div class="panel-body">
                <ul>
        ...
        <article class="ac-container">
          ...
          <div>
            <input
              ...
              checked={true}
            />
            <label for="ac-education-1">
              Interactive Digital Media MSc. · <i>Trinity College Dublin</i> ·
              <span>September 2024 - September 2025 (expected)</span>
            </label>
            <div class="">
              <div class="experience-panel">
                <div class="panel-body">
          ...
          <div>
            <input
              ...
              type="radio"
            />
            <label for="ac-education-2">
              Software and Information Engineering BSc. · <i>TU Wien</i> ·
              <span>September 2017 - October 2022</span>
            </label>
            <div>
              <div class="panel-body">
                <ul>
